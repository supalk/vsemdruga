...
@section('content')
    <div class="page-lib">
        <div class="ui center aligned blue header">Справочник причин эвтаназии</div>
        ...
        <div class="ui bottom attached tab" data-tab="edit">
            ...
            <form class="ui form frm-add" onsubmit="return false;" method="post">
                ...
                <div class="ui inline required field">
                    ...
                    <input style="width:calc(100% - 100px)" id="name" name="euthanasia_name" type="text" class="inp_change">
                </div>
    ...
    <script>
        ...
        let page = {
            ...
            save() {
                ...
                window.app.send({
                    url: '/lib/reason_euthanasia/save',
                    data: formData
                }, function (data) {
                    $.tab('change tab', 'list');
