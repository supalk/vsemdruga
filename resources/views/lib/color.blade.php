...
@section('content')
    <div class="page-lib">
        <div class="ui center aligned blue header">Справочник окрасок</div>
        ...
        <div class="ui bottom attached tab" data-tab="edit">
            ...
            <form class="ui form frm-add" onsubmit="return false;" method="post">
                ...
                <div class="ui inline required field">
                    ...
                    <input style="width:calc(100% - 100px)" id="name" name="coloring_name" type="text" class="inp_change">
                </div>
